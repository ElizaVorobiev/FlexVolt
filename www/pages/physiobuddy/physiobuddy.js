(function () {
    ...
    .controller('PhysiobuddyCtrl', ['$stateParams', '$scope', '$state', 'flexvolt', '$ionicPopover', '$ionicModal', 'tracePlot', 'traceLogic', 'dataHandler', 'hardwareLogic', 'logicOptions', 'customPopover',
    function($stateParams, $scope, $state, flexvolt, $ionicPopover, $ionicModal, tracePlot, traceLogic, dataHandler, hardwareLogic, logicOptions, customPopover) {
        ...
        customPopover.add($ionicPopover, $scope, 'popover', 'pages/physiobuddy/physiobuddy-settings.html',traceLogic.updateSettings);
        ...
        customPopover.addHelp($ionicModal, $scope, 'helpModal','pages/physiobuddy/physiobuddy-help.html');
